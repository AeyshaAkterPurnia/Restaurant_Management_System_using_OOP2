...
{
    partial class Manager_orderHistory
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView_newOrder = new DataGridView();
            label_newHistory = new Label();
            panel_userDash.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridView_newOrder).BeginInit();
            SuspendLayout();
            // 
            // panel_userDash
            // 
            ...
            button_userDetails.Location = new Point(15, 556);
            ...
            button_manager_orderHistory.ForeColor = Color.Black;
            ...
            button_manager_add_user.ForeColor = Color.White;
            ...
            // 
            // dataGridView_newOrder
            // 
            dataGridView_newOrder.BackgroundColor = Color.White;
            dataGridView_newOrder.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridView_newOrder.GridColor = Color.White;
            dataGridView_newOrder.Location = new Point(246, 243);
            dataGridView_newOrder.Margin = new Padding(3, 4, 3, 4);
            dataGridView_newOrder.Name = "dataGridView_newOrder";
            dataGridView_newOrder.RowHeadersWidth = 51;
            dataGridView_newOrder.Size = new Size(734, 420);
            dataGridView_newOrder.TabIndex = 24;
            // 
            // label_newHistory
            // 
            label_newHistory.AutoSize = true;
            label_newHistory.BackColor = Color.White;
            label_newHistory.Font = new Font("Times New Roman", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 0);
            label_newHistory.ForeColor = Color.Black;
            label_newHistory.Location = new Point(536, 185);
            label_newHistory.Name = "label_newHistory";
            label_newHistory.Size = new Size(151, 27);
            label_newHistory.TabIndex = 23;
            label_newHistory.Text = " Order History";
            // 
            // Manager_orderHistory
            // 
            AutoScaleDimensions = new SizeF(8F, 20F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(1029, 800);
            Controls.Add(dataGridView_newOrder);
            Controls.Add(label_newHistory);
            Controls.Add(userDashboard_close);
            Controls.Add(label_title);
            Controls.Add(button_Manager_Back);
            Controls.Add(panel_userDash);
            FormBorderStyle = FormBorderStyle.None;
            Margin = new Padding(3, 4, 3, 4);
            Name = "Manager_orderHistory";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Manager_orderHistory";
            Load += Manager_orderHistory_Load;
            panel_userDash.ResumeLayout(false);
            panel_userDash.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridView_newOrder).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private DataGridView dataGridView_newOrder;
        private Label label_newHistory;
